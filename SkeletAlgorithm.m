...
% Folder Selection
seg_folder = "ICON_Phoenix\P1\ODMasks\MAT\";
...
for i=1:length(seg_files)
    ...
    skel_name =  "ICON_Phoenix\P1\Skeletonization_Results\JPG\Skel_" + seg_name(1) + ".jpg";
    imwrite(skel, skel_name);

    matSkel_name = "ICON_Phoenix\P1\Skeletonization_Results\MAT\Skel_" + seg_name(1) + ".mat";
